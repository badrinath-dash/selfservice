                                    ...
                                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                                        ...
                                        <div style={{
                                            ...
                                            <div>
                                                ...
                                                <div style={{ fontSize: '14px', fontWeight: 600 }}>{ConvertToGB(asset.index_size_mb)}</div>
                                            </div>
                                            <div>
                                                <div style={{ fontSize: '10px', color: '#9AA4AE', textTransform: 'uppercase' }}>Avg Usage</div>
                                                <div style={{ fontSize: '14px', fontWeight: 600 }}>{ConvertToGB(asset.avg_index_usage_mb)}</div>
                                            </div>
                                            <div>
