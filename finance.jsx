    ...
    <ColumnLayout.Row>
      <ColumnLayout.Column span={2}>
        <ControlGroup
          ...
          required
          error={!!applicationFormErrors.laborNWACode}
        >
          <Text
            style={{ width: '200px' }}
            name="laborNWACode"
      ...
      <ColumnLayout.Column span={1}>
        <ControlGroup
          ...
          required
          error={!!applicationFormErrors.laborNWAExpiryDate}
        >
          <Date
              ...
              <Card key={1}>
                ...
                <Card.Body>
                  <ColumnLayout>
                    <ColumnLayout.Row>
                      <ColumnLayout.Column span={2}>
                        <ControlGroup
                          ...
                          required
                          error={!!applicationFormErrors.infrastructureNWACode}
                        >
                          <Text
                            style={{ width: '200px' }}
                            name="infrastructureNWACode"
                      ...
                      <ColumnLayout.Column span={1}>
                        <ControlGroup
                          ...
                          tooltip="NWA Code should be valid for at least 3 months from project start"
                          required
                          error={!!applicationFormErrors.infraNWAExpiryDate}
                        >
                          <Date
                            name="infraNWAExpiryDate"
                            highlightToday
                    ...
                    {applicationFormData?.standardAPIRequestType === 'Yes' &&
                      renderLaborNWASection()}
                  </ColumnLayout>
                </Card.Body>
              </Card>
            </CardLayout>
